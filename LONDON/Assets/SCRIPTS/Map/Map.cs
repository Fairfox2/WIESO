...
public class Map : MonoBehaviour
{
    ...
    private void Random_Map()
    {
        ...
        Rohstoffe.singleton.Lehm_Genarator(6,25,2.3f,4);  // ein lehm der zimlich fix ist das man am anfang lehm hat 
        Rohstoffe.singleton.Lehm_Genarator(Random.Range(10,14),Random.Range(34,45), Random.Range(4,4.5f), 5);  //Random Lehm Biom mit 5-8 lehmstücken und mit dem radius 30-54 auf der Zone 2-3.5 und mit einer Toleranz von 6
